  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-white p-6 border border-gray-200 rounded-lg mb-8">
        <h3 className="text-lg font-semibold mb-4">🎮 Test Prefetching</h3>
      ...
      <div className="bg-blue-50 p-4 border border-blue-200 rounded-lg">
        ...
        <ul className="text-sm text-blue-700 space-y-1">
          <li>• <strong>Click "Test Click Prefetch"</strong> - Triggers immediate prefetch</li>
          <li>• <strong>Hover over green button</strong> - Triggers hover prefetch with delay</li>
          <li>• <strong>Watch the logs</strong> - See prefetch activity in real-time</li>
          <li>• <strong>Check stats</strong> - Monitor queue length and active prefetches</li>
          <li>• <strong>Open DevTools</strong> - See console logs and network activity</li>
        </ul>
      </div>
    </div>
  );
