...
export default function PrefetchLazyDemoPage() {
  ...
  const triggerIdlePrefetch = () => {
    browserPrefetchManager.triggerPrefetch('idle');
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">🚀 Prefetching & Lazy Loading Demo</h1>
          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <ul className="text-sm text-blue-700 space-y-1">
                <li>• <strong>Hover over products</strong> - Triggers prefetching (check console)</li>
                <li>• <strong>Scroll down</strong> - Lazy loads more products</li>
                <li>• <strong>Wait 2 seconds</strong> - Idle prefetching activates</li>
                <li>• <strong>Check stats below</strong> - Monitor prefetch activity</li>
                <li>• <strong>Open DevTools</strong> - See network requests</li>
              </ul>
            </div>
            <button
      ...
      {/* Product Grid */}
      <div className="bg-white p-4 border border-gray-200 rounded-lg">
        <h3 className="text-lg font-semibold mb-4">🛍️ Product Grid (Lazy Loading + Prefetching)</h3>
      ...
      <div className="mt-8 p-4 bg-green-50 border border-green-200 rounded-lg">
        <h3 className="text-lg font-semibold text-green-800 mb-2">✅ What You Should See:</h3>
        <ul className="text-sm text-green-700 space-y-1">
          <li>• <strong>Immediate display</strong> of first 6 products</li>
          <li>• <strong>Lazy loading</strong> of more products as you scroll</li>
          <li>• <strong>Prefetch logs</strong> in console when hovering over products</li>
          <li>• <strong>Stats updates</strong> showing queue and active prefetches</li>
          <li>• <strong>Idle prefetching</strong> after 2 seconds of inactivity</li>
        </ul>
      </div>
    </div>
  );
